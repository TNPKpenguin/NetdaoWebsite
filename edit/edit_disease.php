...
<link rel="stylesheet" href="../css/disease.css">
        ...
        <div class="wrapper">
            ...
            <form action="../includes/insert_update_disease.php" method="post">
            <div class="header">
        ...
        <br><br>
            <div class="first-box">
                    <div class="form-group">
                        <!-- <label for="name">ระบบ</label> -->
                            ...
                            <div class="col-sm-12" id="day">
                                <select class="form-control" id="sytem_disease_edit" style="margin-bottom:20px; width:100%; height:35px" name="day">
                    ...
                    <table class="table align-middle mb-0 bg-white">
                        ...
                        <tbody>
                        <?php
                        $sql2 = "SELECT * FROM link_sym l,symptoms s WHERE l.sym_id = s.sym_id and case_id = '{$_GET['case_id']}';";
                    ...
                    <?php
                        ...
                        echo (' <a href=\'../Treatment.php?hn='.$_GET['hn'].'\'>
